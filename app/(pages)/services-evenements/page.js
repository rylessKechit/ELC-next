  ...
  return (
    <div className="services-evenements-page">
      ...
      >
        ...
        <div className="container-custom relative z-20 text-white">
          <motion.div 
            ...
            className="max-w-3xl"
          >
            <h1 className="mb-6">SERVICES <span className="text-primary">ÉVÉNEMENTIELS</span></h1>
      ...
      >
        <div className="container-custom">
          <div className="text-center mb-16">
            <h2>NOS FORFAITS ÉVÉNEMENTIELS</h2>
            <p className="subtitle">Des options adaptées à tous vos besoins</p>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Forfait Mariage Essentiel</h3>
                <p className="text-gray-600 mb-6">
                  L'essentiel pour le transport des mariés lors de votre journée spéciale.
                </p>
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  <div className="text-xl font-bold text-primary">À partir de 490€</div>
                  <p className="text-gray-500 text-sm">Pour une journée (jusqu'à 6h)</p>
                </div>
                <ul className="mb-8 space-y-2">
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span>Berline de luxe décorée</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                  ...
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span>Bouteille de champagne</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span>Transport des mariés</span>
                  </li>
                </ul>
            ...
            >
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-bold mb-2">Forfait Mariage Premium</h3>
                <p className="text-gray-600 mb-6">
                  Une solution complète pour les mariés et leurs proches.
                </p>
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  <div className="text-xl font-bold text-primary">À partir de 890€</div>
                  <p className="text-gray-500 text-sm">Pour une journée (jusqu'à 8h)</p>
                </div>
                <ul className="mb-8 space-y-2">
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span>Berline premium pour les mariés</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span>Véhicule supplémentaire pour la famille</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                  ...
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span>Champagne et rafraîchissements</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span>Service photo du chauffeur</span>
                  </li>
                </ul>
                <Link href="/contact" className="btn btn-primary w-full">
                  Demander un devis
            ...
            >
              <div className="p-1 bg-primary"></div>
              <div className="p-6">
                <h3 className="text-xl font-bold mb-2">Forfait Événements Corporate</h3>
                <p className="text-gray-600 mb-6">
                  Transport professionnel pour vos événements d'entreprise.
                </p>
                <div className="bg-gray-50 p-4 rounded-lg mb-6">
                  <div className="text-xl font-bold text-primary">Sur mesure</div>
                  <p className="text-gray-500 text-sm">Selon vos besoins spécifiques</p>
                </div>
                <ul className="mb-8 space-y-2">
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span>Flotte adaptée au nombre d'invités</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span>Coordination logistique complète</span>
                  </li>
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                  ...
                  <li className="flex items-center">
                    <i className="fas fa-check text-primary mr-3"></i>
                    <span>Plateforme de suivi en temps réel</span>
                  </li>
                </ul>
                <Link href="/contact" className="btn btn-primary w-full">
                  Demander un devis
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-4">
              Tous nos forfaits sont personnalisables selon vos besoins spécifiques
            </p>
