...
/**
 * Composant calendrier pour visualiser et gérer les réservations
 * @param {Object} props
 * @param {string} props.statusFilter - Filtre optionnel par statut
 */
const BookingCalendar = ({ statusFilter = 'all' }) => {
                ...
                return (
                  ...
                  >
                    <div className={`text-right p-1 ${
                      isCurrentMonth ? isToday ? 'text-primary font-bold' : '' : 'text-gray-400'
                    }`}>
                      {date.getDate()}
                    </div>
