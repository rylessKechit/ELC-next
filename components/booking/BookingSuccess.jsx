// components/booking/BookingSuccess.jsx - Version simplifiée
"use client";
  ...
  return (
    <div className={`bg-white rounded-lg shadow-custom p-6 ${showPrintVersion ? 'print-version' : ''}`}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
          ...
          <div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4 flex items-center">
              ...
              <div>
                <h4 className="font-medium">Véhicule de luxe</h4>
                ...
                <div className="flex items-center text-sm text-gray-600">
                  <div className="flex items-center mr-4">
                    ...
                    {bookingData.passengers} passager{bookingData.passengers > 1 ? 's' : ''}
                  </div>
                  <div className="flex items-center">
                    ...
                    {bookingData.luggage} bagage{bookingData.luggage > 1 ? 's' : ''}
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white border border-gray-200 rounded-lg p-4">
              ...
              <div className="text-sm text-gray-600">
                ...
                <a href="tel:+33643537653" className="block mt-2 text-primary font-medium flex items-center">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-4 mt-6">
        <button 
          onClick={handlePrint} 
          className="py-2 px-4 border border-gray-300 rounded-full text-gray-700 hover:bg-gray-50 transition-colors duration-300 flex items-center justify-center"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
        ...
        <Link 
          href="/" 
          className="py-2 px-4 bg-primary text-white rounded-full font-medium hover:bg-primary-dark hover:text-white transition-colors duration-300 flex items-center justify-center"
        >
          <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
